...
const messages = {
  en: {
    ...
    doctorBrowserMissing: 'No supported Chrome, Edge, Chromium, or Brave executable was found.',
    doctorHint: 'Install a browser or set TOLEDO_BROWSER_PATH to its executable. Ubuntu Snap Chromium is normally /snap/bin/chromium.',
  ...
  zh: {
    ...
    mainQuestion: '请选择操作', signIn: '登录 Toledo', discoverCourses: '读取课程', selectCourses: '选择课程', checkUpdates: '检查并审阅更新', settings: '设置', resetBrowser: '重置浏览器会话', exit: '退出', status: '状态', statusSignedIn: '本地已登录', statusSignInRequired: '需要登录', statusCourses: '已选 {selected} · 可用 {available} · 共发现 {total}',
