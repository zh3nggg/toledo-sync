const translations = {
  ...
  nl: { tagline: 'Lokale synchronisatie van KU Leuven Toledo-cursusmateriaal', language: 'Taal', setupTitle: 'Downloadinstellingen', setupText: 'Cursusmappen worden rechtstreeks aangemaakt in de gekozen downloadmap.', vault: 'Obsidian Vault', downloadRoot: 'Downloadhoofdmap', downloadHint: 'Voorbeeld: D:\\Courses\\2026-2027\\G0S96A Groups and Symmetries', choose: 'Map kiezen', academicYear: 'Academiejaar', saveSettings: 'Instellingen opslaan', openDownloadRoot: 'Downloadmap openen', coursesTitle: 'Cursusselectie', coursesText: 'Selectie bepaalt het synchronisatiebereik; de ontdekkingsstatus staat apart.', discover: 'Alle cursussen zoeken', syncTitle: 'Aanmelden en synchroniseren', syncText: 'Meld één keer aan; latere synchronisaties gebeuren op de achtergrond.', login: 'Aanmelden bij Toledo', syncSelected: 'Geselecteerde cursussen synchroniseren', activity: 'Activiteit en resultaten', discovered: 'Gevonden · klaar om te synchroniseren', notDiscovered: 'Niet gevonden', saved: 'Instellingen opgeslagen.', chooseVault: 'Obsidian Vault kiezen', chooseOutput: 'Downloadhoofdmap kiezen', syncing: 'Bezig met synchroniseren…', error: 'Fout' }
};
